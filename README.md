...
# Team 6 — Asynchronous PDF Receipt Generation
## Use Cases
- RegisterUser
...
- POST /orders/{orderId}/receipt (creates PendingTask)
- GET /task/receipt (download one PDF for each PendingTask in PENDING status. Then updates PendingTaks to DONE or ERROR properly)
